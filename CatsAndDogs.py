...
class Main:
    ...
    def __init__(self, parent):
        ...
        def DocumentFrame(TextFile = "source/TextData.txt"):
            ...
            """
            DocumentFrame = tk.LabelFrame(parent, width = 545, height = 75, text = "How it works", padx = 1, pady= 1, fg = white, bg = dark)
        ...
        def MainFrame(TextFile = "source/TextData.txt"):
            """This is going to contain the main functionality of the program.
            """
            MainFrame = tk.LabelFrame(parent, text = "What it needs is an image", padx = 5, pady = 5, fg = white, bg = dark)
            ...
            tk.Button(MainFrame, text = "Insert", fg = white, bg = dark, command = lambda: self.Predict(EntryText.get().strip()), padx = 5).grid(row = 3, column = 3)
